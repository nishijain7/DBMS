...
--2 Get the particular borrowers who have borrowed more than 3 books from Jan 2020 
select card_no
from book_lending
...
--5. Create a view of all books and its number of copies which are currently available in th
